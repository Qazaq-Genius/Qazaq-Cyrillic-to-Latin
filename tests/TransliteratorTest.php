...
require __DIR__ . "/../src/Transliterator.php";
...
{
    const STRING_CYRILLIC_1
        = 'Барлық адамдар тумысынан азат және қадір-қасиеті мен ' .
    ...
    const STRING_OFFICIAL_LATIN_2021_01_WIKI_1
        = "Barlyq adamdar tumysynan azat jäne qadır-qasietı men " .
    ...
    const STRING_OFFICIAL_LATIN_2021_04_WIKI_1
        = 'Barlyq adamdar tumysynan azat jäne qadır-qasietı men ' .
        'qūqyqtary teñ bolyp düniege keledı. Adamdarğa aqyl-parasat, ' .
        'ar-ojdan berılgen, sondyqtan olar bır-bırımen tuystyq, ' .
        'bauyrmaldyq qarym-qatynas jasaulary tiıs.';

    const ANTHEM_CYRILLIC_PT1
        = "Алтын күн аспаны," .
        "Алтын дән даласы," .
        "Ерліктің дастаны –" .
        "Еліме қарашы!" .
        ...
        "Намысын бермеген," .
        "Қазағым мықты ғой!";
    const ANTHEM_OFFICIAL_LATIN_2021_PT1
        = "Altyn kün aspany," .
        "Altyn dän dalasy," .
        "Erlıktıñ dastany –" .
        "Elıme qaraşy!" .
    ...
    const ANTHEM_CYRILLIC_PT3
        ...
        "Біздің ел бақытты," .
        "Біздің ел осындай!";
    const ANTHEM_OFFICIAL_LATIN_2021_PT3
        = "Ūrpaqqa jol aşqan," .
    ...
    public static function lyricsDataMap()
    {
        return [
